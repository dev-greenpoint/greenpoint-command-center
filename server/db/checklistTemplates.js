...
const SERVICE_CHECKLIST = {
  ...
  'Content - Social': [
    ...
    'Scheduling tool access set up',
  ],
  'Content - eDM': [
    'eDM platform access confirmed',
    'Audience segments defined',
    'Send schedule agreed',
  ],
  'Content - Web/Blogs/Other Copy': [
    'Copy brief confirmed',
    'Style guide and tone of voice agreed',
    'SEO keywords identified',
  ],
  'Content - Influencer': [
    'Influencer criteria agreed with client',
    'Budget and gifted or paid model confirmed',
    'Disclosure requirements confirmed',
  ],
  'Content - Shortform Capture': [
    'Shoot brief confirmed',
    'First shoot scheduled',
    'Asset delivery process agreed',
  ],
  'Content - Video Production': [
    'Video brief confirmed',
    'Pre-production meeting scheduled',
    'Talent and location confirmed',
    'Permits and releases arranged',
  ],
...
module.exports = { GENERAL_CHECKLIST, SERVICE_CHECKLIST };
